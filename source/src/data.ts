...
export const initialState: AppState = {
  ...
  settings: {
    ...
    diagnosticSensitivity: "balanced",
    diagnosticSamePeriod: true,
    diagnosticIncomeTrends: true,
    diagnosticExpenseTrends: true,
    diagnosticCategoryTrends: true,
    diagnosticBudgetPace: true,
    diagnosticProjections: true,
    diagnosticBillAlerts: true,
    diagnosticSmallExpenses: true,
    diagnosticShowPositive: true,
    diagnosticShowWarnings: true,
    diagnosticShowNeutral: true,
